...
def run():
    ...
    activities = ["Applicant", "Company"]
    choice = st.sidebar.selectbox("Choose among the given options:", activities)
    # link = '[©Developed by Spidy20](http://github.com/spidy20)'
    # st.sidebar.markdown(link, unsafe_allow_html=True)
    img = Image.open('./Logo/SRS_logo.jpg')
    ...
    if choice == 'Applicant':
        ...
        if pdf_file is not None:
            ...
            if resume_data:
                ...
                st.video('https://youtu.be/yp693O87GmM')
                ...
                st.video('https://youtu.be/oVVdezJ0e7w')
        ...
        if st.button('Login'):
            if (ad_user == 'Company1' or ad_user=='Company2' or ad_user=='Company3') and  ad_password == '12345':
                st.success("Welcome")
                # Display Data
